...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget _item(Message element, int posicion, String uid) {
    return Card(
      ...
      color: uid == element.senderUid ? Colors.blue[200] : Colors.grey[300],
      child: ListTile(
        leading: CircleAvatar(
          backgroundColor:
              uid == element.senderUid ? Colors.white38 : Colors.black26,
          child: uid == element.senderUid
              ? const Icon(
      ...
      children: [
        ...
        Padding(
          ...
          child: IconButton(
              ...
              icon:
                  const Icon(Icons.send_rounded, size: 27, color: Colors.blue)),
        ),
      ],
    );
  }
